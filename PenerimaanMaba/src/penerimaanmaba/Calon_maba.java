...
public class Calon_maba extends JFrame {
    ...
    private void initCalonMahasiswaPanel() {
        ...
        JButton btnEditan = new JButton("Editan");
        ...
        btnEditan.addActionListener(e -> {
        int selectedRow = tabelHasil.getSelectedRow();
        if (selectedRow >= 0) {
            try {
                String namaMahasiswa = tfNamaMahasiswa.getText();
                String alamat = tfAlamat.getText();
                String telepon = tfTelepon.getText();
                String namaProdi = tfNamaProdi.getText();
                String kodeProdi = tfKodeProdi.getText();
                String asalSekolah = tfAsalSekolah.getText();
                String namaOrangTua = tfNamaOrangTua.getText();

                tableModel.setValueAt(namaMahasiswa, selectedRow, 0);
                tableModel.setValueAt(alamat, selectedRow, 1);
                tableModel.setValueAt(telepon, selectedRow, 2);
                tableModel.setValueAt(namaProdi, selectedRow, 3);
                tableModel.setValueAt(kodeProdi, selectedRow, 4);
                tableModel.setValueAt(asalSekolah, selectedRow, 5);
                tableModel.setValueAt(namaOrangTua, selectedRow, 6);
                ...
                JOptionPane.showMessageDialog(panelCalonMahasiswa, "Pilih baris yang akan disimpan", "Peringatan", JOptionPane.WARNING_MESSAGE);
            }
        });
    ...
    private void initNilaiUjianPanel() {
        ...
        if (selectedRow >= 0) {
            try {
                ...
                String namaMahasiswa = tfNamaMahasiswa.getText();
                int matematika = Integer.parseInt(tfMatematika.getText());
                int bahasaIndonesia = Integer.parseInt(tfBahasaIndonesia.getText());
                int bahasaInggris = Integer.parseInt(tfBahasaInggris.getText());

                tableModel.setValueAt(id, selectedRow, 0);
                tableModel.setValueAt(namaMahasiswa, selectedRow, 1);
                tableModel.setValueAt(matematika, selectedRow, 2);
                tableModel.setValueAt(bahasaIndonesia, selectedRow, 3);
                tableModel.setValueAt(bahasaInggris, selectedRow, 4);
                ...
                JOptionPane.showMessageDialog(panelNilaiUjian, "Pilih baris yang akan disimpan", "Peringatan", JOptionPane.WARNING_MESSAGE);
                }
            });
